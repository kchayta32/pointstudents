...
// ============================================
const initialGroups = {
    "1": { members: ["แนน", "นก", "เฟรช", "มา", "มี่", "โอ้ค"] },
    ...
    "7": { members: ["เจ๋งซอยมังกร", "ปั๊บโป๊เตโต้", "แฟ้มลาซาล", "บูมบางแค", "อลัม"] },
    "8": { members: ["เซน", "บอส", "ปอย", "ปาย", "โบ้"] },
    "9": { members: ["โอ๊ต", "เต้", "โฟน", "อาท", "ฟลุ๊ค", "เขตต์"] },
    "10": { members: ["มิ้น", "กาญ", "สุนิสา"] },
    "11": { members: ["กฤศ", "โต้", "น้อยหน่า", "จู้", "กี้", "พี่อาม"] },
    "12": { members: ["กิจ", "โอม"] }
};
...
const memberData = {
    ...
    "โอ้ค": { studentId: "66122519066", fullName: "นายธนพัต ฉุยสุริฉาย" },
    ...
    // กลุ่มที่ 3
    "ต้า": { studentId: "66122519038", fullName: "นายสิทธิกร อุ้มนุช" },
    "เขต": { studentId: "66122519076", fullName: "นายฐิติโชติ โสดาจันทร์" },
    "เนย": { studentId: "66122519058", fullName: "นางสาวเนยะนัยต์ แซ่เหลา" },
    "น้ำ": { studentId: "66122519041", fullName: "นางสาวสุธิดา สารบรรณ" },
    "หญิง": { studentId: "66122519021", fullName: "นางสาวอารียา สะอาดเอี่ยม" },
    "โอ๊ค": { studentId: "66122519051", fullName: "นายแสนดี กันภัย" },

    // กลุ่มที่ 4
    "ม่อน": { studentId: "66122519069", fullName: "นายตรีเพชร รุ่งเรือง" },
    "ปลื่ม": { studentId: "66122519071", fullName: "นายปิติภัทร จันทร์เพ็ญ" },
    "บิ๊ก": { studentId: "66122519052", fullName: "นายสหรัฐ เทศน์ดี" },
    ...
    "ปั๊บโป๊เตโต้": { studentId: "66122519074", fullName: "นายภัททากร ขุนพรม" },
    "แฟ้มลาซาล": { studentId: "66122519034", fullName: "นายกฤษณพงศ์ มนต์แก้ว" },
    "บูมบางแค": { studentId: "66122519063", fullName: "นายธนากรณ์ สุวรรณสุข" },
    ...
    "บอส": { studentId: "661225190", fullName: "นายบัญญพนธ์ กรุดนาค" },
    "ปอย": { studentId: "66122519091", fullName: "นางสาวทิฆัมพร มาให้ทรัพย์" },
    "ปาย": { studentId: "66122519086", fullName: "นายตะลันต์ พฤฒิสวัสดี" },
    "โบ้": { studentId: "66122519090", fullName: "นายวรภัทร อึ้งวานิช" },

    // กลุ่มที่ 9
    "โอ๊ต": { studentId: "66122519061", fullName: "นายจตุรเทพ รัตนวรเศวต" },
    "เต้": { studentId: "66122519073", fullName: "นาระพีพัฒน์ ภูพิลา" },
    "โฟน": { studentId: "66122519064", fullName: "นายฐาปนพงศ์ ดิษฐ์สุธรรม" },
    "อาท": { studentId: "66122519087", fullName: "นายภูมิระพี แพร์ขลิบ" },
    "ฟลุ๊ค": { studentId: "66122519053", fullName: "นายทวีศักดิ์ สุวรรณพานิช" },
    "เขตต์": { studentId: "66122519077", fullName: "นายรัฐเขตต์ จันทร์เพ็ง" },
    ...
    "กฤศ": { studentId: "66122519031", fullName: "นายกฤศ เจริญทรัพย์" },
